...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<vispt-big-input-action></vispt-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<vispt-big-input-action [disabled]="true"></vispt-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<vispt-big-input-action fontSet="fas" fontIcon="fa-trash"></vispt-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<vispt-big-input-action label="delete"></vispt-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<vispt-big-input-action (action)="actionHandler()"></vispt-big-input-action>`;
    fixture = createHostComponent(template);
